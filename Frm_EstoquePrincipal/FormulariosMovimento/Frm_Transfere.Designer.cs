namespace EstoqueTI.FormulariosMovimento
{
    partial class Frm_Transfere
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_Transfere));
            lbl_item = new Label();
            lbl_valor = new Label();
            txt_valor = new TextBox();
            lbl_fornecedor = new Label();
            lbl_motivo = new Label();
            btn_Transfere = new Button();
            ...
            // btn_Transfere
            // 
            btn_Transfere.ForeColor = Color.Black;
            btn_Transfere.Location = new Point(12, 685);
            btn_Transfere.Name = "btn_Transfere";
            btn_Transfere.Size = new Size(850, 46);
            btn_Transfere.TabIndex = 14;
            btn_Transfere.Text = "Transferir";
            btn_Transfere.UseVisualStyleBackColor = true;
            btn_Transfere.Click += btn_Transfere_Click;
            // 
            // cb_fornecedor
            // 
            ...
            pictureBox1.Size = new Size(850, 139);
            ...
            // cb_cc
            // 
            cb_cc.FormattingEnabled = true;
            cb_cc.Items.AddRange(new object[] { "Administrador", "Usuário Padrão" });
            cb_cc.Location = new Point(431, 395);
            cb_cc.Name = "cb_cc";
            cb_cc.Size = new Size(431, 28);
            cb_cc.TabIndex = 25;
            // 
            // lbl_cc
            // 
            lbl_cc.AutoSize = true;
            lbl_cc.Font = new Font("Tahoma", 16.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            lbl_cc.ForeColor = SystemColors.ControlLightLight;
            lbl_cc.Location = new Point(431, 348);
            lbl_cc.Name = "lbl_cc";
            lbl_cc.Size = new Size(195, 34);
            lbl_cc.TabIndex = 24;
            lbl_cc.Text = "Conta Contábil";
            // 
            // txt_local
            // 
            txt_local.Location = new Point(426, 479);
            txt_local.Name = "txt_local";
            txt_local.Size = new Size(436, 27);
            txt_local.TabIndex = 27;
            // 
            // lbl_local
            // 
            lbl_local.AutoSize = true;
            lbl_local.Font = new Font("Tahoma", 16.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            lbl_local.ForeColor = SystemColors.ControlLightLight;
            lbl_local.Location = new Point(426, 442);
            lbl_local.Name = "lbl_local";
            lbl_local.Size = new Size(78, 34);
            lbl_local.TabIndex = 26;
